...
class DataPlotlyPanelWidget(QgsPanelWidget, WIDGET):  # pylint: disable=too-many-lines,too-many-instance-attributes,too-many-public-methods
    ...
    def refreshWidgets(self):  # pylint: disable=too-many-statements,too-many-branches
        ...
        self.widgetType = {
            ...
            self.y_axis_min: ['scatter', 'bar', 'box', '2dhistogram', 'violin'],
            self.y_axis_max: ['scatter', 'bar', 'box', '2dhistogram', 'violin'],
            self.y_axis_min_defined_button: ['scatter', 'bar', 'box', '2dhistogram', 'violin'],
            self.y_axis_max_defined_button: ['scatter', 'bar', 'box', '2dhistogram', 'violin'],
    ...
    def set_settings(self, settings: PlotSettings):  # pylint: disable=too-many-statements
        ...
        self.x_combo.setExpression(settings.properties.get(['x_name'], None))
        self.y_combo.setExpression(settings.properties.get(['y_name'], None))
        self.z_combo.setExpression(settings.properties.get(['z_name'], None))
        self.in_color_combo.setColor(QColor(settings.properties.get(['in_color']), None))
        self.marker_size.setValue(settings.properties.get(['marker_size'], None))
        ...
        self.color_scale_data_defined_in_check.setChecked(settings.properties.get(['color_scale_data_defined_in_check'], None))
        self.color_scale_data_defined_in_invert_check.setChecked(
            settings.properties.get(['color_scale_data_defined_in_invert_check'], None))
        self.out_color_combo.setColor(QColor(settings.properties.get(['out_color'], None)))
        self.marker_width.setValue(settings.properties.get(['marker_width'], None))
        self.marker_type_combo.setCurrentText(settings.properties.get(['marker_type_combo'], None))
        self.point_combo.setCurrentText(settings.properties.get(['point_combo'], None))
        self.line_combo.setCurrentText(settings.properties.get(['line_combo'], None))
        self.contour_type_combo.setCurrentText(settings.properties.get(['contour_type_combo'], None))
        self.show_lines_check.setChecked(settings.properties.get(['show_lines_check'], None))
        self.color_scale_combo.setCurrentIndex(self.color_scale_combo.findData(settings.properties.get(['color_scale']), None))
        self.opacity_widget.setOpacity(settings.properties.get(['opacity'], None))
        self.orientation_legend_check.setChecked(settings.layout.get(['legend_orientation'] == 'h', None))
        self.range_slider_combo.setChecked(settings.layout.get(['range_slider']['visible'], None))
        self.plot_title_line.setText(settings.layout.get(['title'], None))
        self.legend_title.setText(settings.properties.get(['name'], None))
        self.x_axis_title.setText(settings.layout.get(['x_title'], None))
        self.y_axis_title.setText(settings.layout.get(['y_title'], None))
        self.z_axis_title.setText(settings.layout.get(['z_title'], None))
        self.info_combo.setCurrentIndex(self.info_combo.findData(settings.properties.get(['hover_text']), None))
        self.additional_info_combo.setExpression(settings.layout.get(['additional_info_expression'], None))
        ...
        self.x_axis_min.setValue(settings.layout['x_min'] if settings.layout.get('x_min', None) is not None else 0.0)
        self.x_axis_max.setValue(settings.layout['x_max'] if settings.layout.get('x_max', None) is not None else 0.0)
        ...
        self.y_axis_min.setValue(settings.layout['y_min'] if settings.layout.get('y_min', None) is not None else 0.0)
        self.y_axis_max.setValue(settings.layout['y_max'] if settings.layout.get('y_max', None) is not None else 0.0)
        self.orientation_combo.setCurrentIndex(self.orientation_combo.findData(settings.properties.get(['box_orientation']), None))
        ...
        self.showMeanCheck.setChecked(settings.properties.get(['show_mean_line'], None))
        self.cumulative_hist_check.setChecked(settings.properties.get(['cumulative'], None))
        self.invert_hist_check.setChecked(settings.properties['invert_hist'] == 'decreasing')
        self.bins_check.setChecked(settings.layout.get(['bins_check'], None))
        self.bins_value.setValue(settings.properties.get(['bins'], None))
        self.bar_gap.setValue(settings.layout.get(['bargaps'], None))
        self.show_legend_check.setChecked(settings.layout.get(['legend'], None))
