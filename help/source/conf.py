# -*- coding: utf-8 -*-
#
# DataPlotly documentation build configuration file, created by
...
project = u'DataPlotly'
copyright = u'2017, Matteo Ghetta'
...
latex_documents = [
  ('index', 'DataPlotly.tex', u'DataPlotly Documentation',
   u'matteo ghetta', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'DataPlotly Documentation',
     [u'matteo ghetta'], 1)
]
